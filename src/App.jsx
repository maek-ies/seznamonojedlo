  ...
  return (
    <div className="app-container">
      <header className="header">
        ...
        <h1 className="title">SeznamonoJedlo</h1>
      </header>
      ...
      {activeTab === 'meals' && (
        <>
          ...
          <div className={viewMode === 'grid' ? "meal-grid" : "meal-list"}>
            {filteredMeals.map(meal => (
              viewMode === 'grid' ? (
                ...
                <div key={meal.id} className="meal-list-item" onClick={() => setSelectedMeal(meal)}>
                  <div className="meal-list-content">
                    <strong>{meal.name}</strong>
                    <span className="meal-list-meta">{meal.category} • {meal.time} • {meal.difficulty}</span>
                  </div>
                  <button
